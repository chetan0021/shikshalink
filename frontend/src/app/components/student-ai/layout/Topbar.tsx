    ...
    return (
        <header className="h-16 bg-[var(--sl-paper)]/20 backdrop-blur-md border-b border-black/10 shrink-0 flex items-center justify-between px-6 relative z-10">
            <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-zinc-400">{user ? "Connected" : "Guest Mode"}</span>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <Button
                    ...
                    className="text-zinc-500 hover:text-sl-primary hover:bg-sl-primary/10 gap-1.5 transition-colors"
                >
                    <LogOut size={15} />
                    Logout
                </Button>
